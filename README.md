...
- Benchmark program: Measure the speed of floating point and integer operations on different processors & compilers, compare them and write a report on it. The floating point operations are done with matrix multiplications and the integer operations are done with a select sort. 
